...
class MainShopListSearchScreen extends StatefulWidget {
  const MainShopListSearchScreen({Key? key}) : super(key: key);

  @override
  State<MainShopListSearchScreen> createState() =>
      _MainShopListSearchScreenState();
}

class _MainShopListSearchScreenState extends State<MainShopListSearchScreen> {
